...
<input name="b" value="1" type="hidden">
	...
	<tr>
        ...
        ?>
						...
						<td class="line-last column-last small"><img class="unit uhero" src="img/x.gif" onclick="document.snd.t11.value=''; return false;" alt="<?php echo U0;?>" title="<?php echo U0;?>"> <input <?php if ($village->unitarray['hero']<=0) {echo 'class="text disabled" disabled="disabled"';} else {echo 'class="text"'; } ?> type="text" name="t11" value="" maxlength="1">
		<?php 
