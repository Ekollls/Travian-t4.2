...
<table cellpadding="0" cellspacing="0" class="transparent compact">
			...
			<table cellpadding="0" cellspacing="0" class="transparent compact">
				<tbody>
					<tr>
						<td>
							<span class="or"><?php echo COORDINATIONS;?>:</span>
<?php
if(isset($_GET['z'])){
...
?>							
    ...
    <button type="submit" value="ok" name="s1" id="btn_ok" class="green ">
		...
		<div class="button-content">	<?php echo CONFIRM;?></div></div></button></form>
