<h1 class="titleInHeader"><?php echo B34;?> <span class="level"> <?php echo LVL.' '.$village->resarray['f'.$id]; ?></span></h1>

    <div id="build" class="gid34">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(34,4);" class="build_logo">
        <img class="building big white g34" src="img/x.gif" alt="<?php echo B34;?>" title="<?php echo B34;?>"/></a>
...
<?php echo CUR_BSTABLITY;?>:</th>
		...
		if ($bindicate==10 || $bindicate==1) $ll -= 1;
			...
			<th><?php echo NEXT_BSTABLITY.' '.($village->resarray['f'.$id]+$nc); ?>:</th>
