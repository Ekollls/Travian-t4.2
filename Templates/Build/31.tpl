<h1 class="titleInHeader"><?php echo B31;?> <span class="level"> <?php echo LVL.' '.$village->resarray['f'.$id]; ?></span></h1>

    <div id="build" class="gid31">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(31,4);" class="build_logo">
        <img class="building big white g31" src="img/x.gif" alt="<?php echo B31;?>" title="<?php echo B31;?>"/></a>
...
<?php echo CUR_DEFBON;?>:</th>
			<td><b><?php echo $bid31[$village->resarray['f'.$id]]['attri']?$bid31[$village->resarray['f'.$id]]['attri']:'0'; ?>%</b></td>
		</tr>
        <?php 
