...
$i = 20;
               echo "<tr><td class=\"desc\">
					...
					<div class=\"details\"><img class=\"r1\" src=\"img/x.gif\" alt=\"".WOOD."\" title=\"".WOOD."\" />".${'u'.$i}['wood']."|<img class=\"r2\" src=\"img/x.gif\" alt=\"".CLAY."\" title=\"".CLAY."\" />".${'u'.$i}['clay']."|<img class=\"r3\" src=\"img/x.gif\" alt=\"".IRON."\" title=\"".IRON."\" />".${'u'.$i}['iron']."|<img class=\"r4\" src=\"img/x.gif\" alt=\"".CROP."\" title=\"".CROP."\" />".${'u'.$i}['crop']."|<img class=\"clock\" src=\"img/x.gif\" alt=\"".HRS."\" title=\"".HRS."\" />";
