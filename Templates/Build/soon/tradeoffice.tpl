...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(17,4, 'gid');"><?php echo B17;?></a> <span><?php echo LVL;?> 20</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(20,4, 'gid');"><?php echo B20;?></a> <span><?php echo LVL;?> 10</span></span>
    </div>
	<div class="clear"></div>
</div>
