...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(22,4);" class="build_logo">
		<img class="building big white g22" src="img/x.gif" alt="<?=B22?>">
	</a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(19,4, 'gid');"><?php echo B19;?></a> <span><?php echo LVL;?> 3</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(15,4, 'gid');"><?php echo B15;?></a> <span><?php echo LVL;?> 3</span></span>
    </div>
	<div class="clear"></div>
</div>
