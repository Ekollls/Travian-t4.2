...
<div class="build_desc">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(11,4, 'gid');"><?php echo B11;?></a> <span><?php echo LVL;?> 20</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(16,4, 'gid');"><?php echo B16;?></a> <span><?php echo LVL;?> 10</span></span>
    </div>
	<div class="clear"></div>
</div>
