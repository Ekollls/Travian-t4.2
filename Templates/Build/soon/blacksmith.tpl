...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(12,4);" class="build_logo">
		<img class="building big white g13" src="img/x.gif" alt="<?php echo B12;?>">
	</a>
    ...
    <a href="#" onclick="return Travian.Game.iPopup(22,4, 'gid');"><?php echo B22;?></a> <span><?php echo LVL;?> 1</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(15,4, 'gid');"><?php echo B15;?></a> <span><?php echo LVL;?> 3</span></span>
    </div>
	<div class="clear"></div>
</div>
