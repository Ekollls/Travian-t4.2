...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(4,4, 'gid');"><?php echo B4;?></a> <span><?php echo LVL;?> 10</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(15,4, 'gid');"><?php echo B15;?></a> <span><?php echo LVL;?> 5</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(8,4, 'gid');"><?php echo B8;?></a> <span><?php echo LVL;?> 5</span></span>
    </div>
	<div class="clear"></div>
</div>
