<h1 class="titleInHeader"><?php echo B33;?> <span class="level"> <?php echo LVL.' '.$village->resarray['f'.$id]; ?></span></h1>

    <div id="build" class="gid33">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(33,4);" class="build_logo">
        <img class="building big white g33" src="img/x.gif" alt="<?php echo B33;?>" title="<?php echo B33;?>"/></a>
...
<?php echo CUR_DEFBON;?>:</th>
            <td><b><?php echo $bid33[$village->resarray['f'.$id]]['attri']?$bid33[$village->resarray['f'.$id]]['attri']:'0'; ?>%</b></td>
        </tr>
        <?php 
