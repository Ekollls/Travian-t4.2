...
<div class=\"costs\">
<div class=\"showCosts\">
                    <span class=\"resources r1 little_res\"><img class=\"r1\" src=\"img/x.gif\" alt=\"".WOOD."\">".${'r'.$i}['wood']."</span>
...
<div class=\"clear\"></div>
                ...
                echo "<div class=\"contractLink\"><button type=\"button\" value=\"&#1578;&#1581;&#1602;&#1740;&#1602; &#1705;&#1585;&#1583;&#1606;\" class=\"build\" onclick=\"window.location.href = 'build.php?id=$id&amp;a=$i&amp;c=".$session->mchecker."'; return false;\">
...
if($success == 0) {
echo "<div class=\"buildActionOverview trainUnits\"><td colspan=\"2\"><div class=\"none\" align=\"center\">".NORESEARCHAVAILABLE."</div></td></div>";
}
?>
...
if($fail > 0) { 
	...
	for($uc=2;$uc<=9;$uc++){
		if(!$technology->meetRRequirement($uc) && !$technology->getTech($uc)) {
			...
			switch($uc){
				case 2:echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">".B22."</a><span class=\"level\"> ".LVL." 1</span>, <a href=\"#\"> ".B13." </a><span class=\"level\"> ".LVL." 1</span></div></div><div class=\"clear\"></div></div><hr>";break;
				case 3: echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">".B22."</a><span class=\"level\"> ".LVL." 5</span>, <a href=\"#\"> ".B13." </a><span class=\"level\"> ".LVL." 1</span></div></div><div class=\"clear\"></div></div><hr>";break;
				case 4: echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">".B22."</a><span class=\"level\"> ".LVL." 5</span>, <a href=\"#\"> ".B20." </a><span class=\"level\"> ".LVL." 1</span></div></div><div class=\"clear\"></div></div><hr>";break;
				case 5:echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">".B22."</a><span class=\"level\"> ".LVL." 5</span>, <a href=\"#\"> ".B20." </a><span class=\"level\"> ".LVL." 5</span></div></div><div class=\"clear\"></div></div><hr>";break;
				case 6: echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">".B22."</a><span class=\"level\"> ".LVL." 5</span>, <a href=\"#\"> ".B20." </a><span class=\"level\"> ".LVL." 10</span></div></div><div class=\"clear\"></div></div><hr>";break;
				case 7: echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">".B22."</a><span class=\"level\"> ".LVL." 10</span>, <a href=\"#\"> ".B21." </a><span class=\"level\"> ".LVL." 1</span></div></div><div class=\"clear\"></div></div><hr>";break;
				case 8:echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">".B22."</a><span class=\"level\"> ".LVL." 15</span>, <a href=\"#\"> ".B21." </a><span class=\"level\"> ".LVL." 10</span></div></div><div class=\"clear\"></div></div><hr>";break;
				case 9: echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">".B22."</a><span class=\"level\"> ".LVL." 20</span>, <a href=\"#\"> ".B16." </a><span class=\"level\"> ".LVL." 10</span></div></div><div class=\"clear\"></div></div>";break;
			}
		}
	}
?>
