<h1 class="titleInHeader"><?php echo B39;?> <span class="level"> <?php echo LVL.' '.$village->resarray['f'.$id]; ?></span></h1>

    <div id="build" class="gid39">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(39,4);" class="build_logo">
        <img class="building big white g39" src="img/x.gif" alt="<?php echo B39;?>" title="<?php echo B39;?>"/></a>
	...
	<?php 
		...
		if ($bindicate==10 || $bindicate==1) $ll -= 1;
			for($nc=1;$nc<=$ll;$nc++){?>
				...
				<td><b><?php echo $bid39[$village->resarray['f'.$id]+$nc]['attri']*STORAGE_MULTIPLIER; ?></b></td>
				</tr>
        <?php
			}
        }
