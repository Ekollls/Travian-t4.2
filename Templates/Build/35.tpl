<h1 class="titleInHeader"><?php echo B35;?> <span class="level"> <?php echo LVL.' '.$village->resarray['f'.$id]; ?></span></h1>

    <div id="build" class="gid35">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(35,4);" class="build_logo">
        <img class="building big white g35" src="img/x.gif" alt="<?php echo B35;?>" title="<?php echo B35;?>"/></a>
       <?php echo B35_DESC; ?></div>

	<table cellpadding="1" cellspacing="1" id="build_value">
		<tr>
			<th><?php echo CUR_ATTBON;?>:</th>
        ...
        if(!$building->isMax($village->resarray['f'.$id.'t'],$id)) {
			...
			for($nc=1;$nc<=$ll;$nc++){?>
				...
				<th><?php echo NEXT_ATTBON.' '.($village->resarray['f'.$id]+$nc); ?>:</th>
