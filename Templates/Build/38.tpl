<h1 class="titleInHeader"><?php echo B38;?> <span class="level"> <?php echo LVL.' '.$village->resarray['f'.$id]; ?></span></h1>

    <div id="build" class="gid38">
    <div class="build_desc">
        <a href="#" onClick="return Travian.Game.iPopup(38,4);" class="build_logo">
        <img class="building big white g38" src="img/x.gif" alt="<?php echo B38;?>" title="<?php echo B38;?>"/></a>
	...
	<?php 
		...
		if ($bindicate==10 || $bindicate==1) $ll -= 1;
			for($nc=1;$nc<=$ll;$nc++){?>
				...
				<td><b><?php echo $bid38[$village->resarray['f'.$id]+$nc]['attri']*STORAGE_MULTIPLIER; ?></b></td>
				</tr>
        <?php
			}
        }
