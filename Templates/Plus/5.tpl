...
و دهکدۀ دومی برای خود بسازد برای شما سکۀ طلای t4dl جایزه 
داده 
خواهد شد که قادر به استفاده از این سکه های طلای  t4dl 
مانند سکه های طلای  t4dl خریداری 
شده خواهید بود.
<br><br>
...
<br>
<span class="link">tx2.t4dl.ir?uc=ref_<?php echo $session->uid; ?></span>
...
بنا کرد، برای شما <img src="img/x.gif" class="gold" alt="سکۀ طلای  t4dl"><b>50</b> داده خواهد شد.</p>
