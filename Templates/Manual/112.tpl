...
<img id="big_unit" class="u12Section" src="img/x.gif" alt="Spearman" title="Spearman" /><div id="t_desc">In the Teuton army the Spearman’s task is defence. He is especially good against cavalry thanks to his weapons length.
<br /><br />
