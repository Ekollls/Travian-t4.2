...
?>
        ...
        <input type="hidden" name="lid" value="<?php echo $lid2; ?>">
			...
			<table cellpadding="1" cellspacing="1" class="transparent">
				<tbody><tr>
					<th><?php echo FARMNAME;?>:</th><?php echo $_GET["lid"]; ?>
					<td>
			...
			<div class="coordinatesInput">
				...
				<div class="clear"></div>
							...
							<select id="target_id" name="target_id" onchange="selectCoordinates()">
								<option value=""><?php echo SELECTVILLAGE;?></option>
							</select>
						</div>
						<div class="clear"></div>
					</td>
...
<div class="button-container"><div class="button-position"><div class="btl"><div class="btr"><div class="btc"></div></div></div><div class="bml"><div class="bmr"><div class="bmc"></div></div></div><div class="bbl"><div class="bbr"><div class="bbc"></div></div></div></div><div class="button-contents"><?php echo DELETE;?></div></div></button>
</form>
</div>
