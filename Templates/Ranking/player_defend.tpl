...
if (isset($_POST['name']) && $_POST['name']!=''){
	...
	$myrank = $ranking->getUserDefRank($_POST['name']);
	$mydata = $database->getUser($_POST['name'],0);
}elseif (isset($_POST['rank'])){
	if($_POST['rank']>$query){ $_POST['rank']=$query;} elseif($_POST['rank']<=0){ $_POST['rank']=1;}
	$myrank = $_POST['rank'];
	$mr = $ranking->procUsersDefRanking();
	$i=0; $myid = $session->uid;
	while($row = mysql_fetch_array($mr)){$i+=1;if($i==$myrank) { $myid=$row['userid'];break;}}
...
<div class="contentNavi tabNavi">
				<div class="container normal">
					...
					<div class="content"><a href="statistiken.php?tid=1"><span class="tabItem"><?php echo OVERVIEW;?></span></a></div>
				</div>
				<div class="container normal">
					<div class="background-start">&nbsp;</div>
					<div class="background-end">&nbsp;</div>
				...
				<div class="container normal">
					<div class="background-start">&nbsp;</div>
					<div class="background-end">&nbsp;</div>
					<div class="content"><a href="statistiken.php?tid=7"><span class="tabItem"><?php echo TOP10;?></span></a></div>
...
<table cellpadding="1" cellspacing="1" id="player_def" class="row_table_data">
	<thead>
		<tr><td></td><td><?php echo PLAYER;?></td><td><?php echo POPULATION;?></td><td><?php echo VILLAGES;?></td><td><?php echo POINTS;?></td></tr>
	</thead>
    <tbody>
<?php
...
$paginationDisplay .=  '<img alt="'.PREVPAGE.'" src="img/x.gif" class="previous disabled">';
$paginationDisplay .= $centerPages;
$paginationDisplay .=  '<a class="next" href="?tid=32&page=' . $nextPage . '"><img alt="'.NEXTPAGE.'" src="img/x.gif"></a> ';
$paginationDisplay .=  '<a class="last" href="?tid=32&page=' . $lastPage . '"><img alt="'.LASTPAGE.'" src="img/x.gif"></a>';

}elseif ($page != "1" && $page != $lastPage){
$paginationDisplay .=  '<a class="first" href="?tid=32&page=1"><img alt="'.FIRSTPAGE.'" src="img/x.gif"></a> ';
$paginationDisplay .=  '<a class="previous" href="?tid=32&page=' . $previous . '"><img alt="'.PREVPAGE.'" src="img/x.gif"></a>';
$paginationDisplay .= $centerPages;
$paginationDisplay .=  '<a class="next" href="?tid=32&page=' . $nextPage . '"><img alt="'.NEXTPAGE.'" src="img/x.gif"></a> ';
$paginationDisplay .=  '<a class="last" href="?tid=32&page=' . $lastPage . '"><img alt="'.LASTPAGE.'" src="img/x.gif"></a>';
