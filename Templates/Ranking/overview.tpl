...
<table cellpadding="1" cellspacing="1" id="player" class="row_table_data">
	<thead>
		<tr><td></td><td><?php echo PLAYER;?></td><td><?php echo ALLIANCE;?></td><td><?php echo POPULATION;?></td><td><?php echo VILLAGES;?></td><?php 			if($session->access == ADMIN) { echo "<td>ویرایش</td>"; } ?></tr>
	</thead>
	<tbody>
<?php
...
$paginationDisplay .=  '<img alt="'.LASTPAGE.'" src="img/x.gif" class="last disabled">';
	...
	while($row = mysql_fetch_array($sql2)){
        ...
        echo "<td class=\"vil\">".$row['totalvillages']."</td>";
 		if($session->access == ADMIN) { echo "<td class=\"pop\" ><a href='editplayer.php?id=".$row['userid']."'>ویرایش</a></td></tr>"; }    
		$rank++;
	}
