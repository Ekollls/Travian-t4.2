...
if (isset($_POST['name']) && $_POST['name']!=''){
	...
	if(empty($mydata)){ $mydata['id']=$session->alliance; $err = USR_NT_FOUND;}
	...
	$i=0; $myid = $session->alliance;
	while($row = mysql_fetch_array($mr)){$i+=1;if($i==$myrank) { $myid=$row['id'];break;}}
...
<h4 class="round"><?php echo TOPATTACKINGALLIANCES;?></h4>
<?php if(isset($err)) echo '<h5 style="color:#f00;">'.$err.'</h5>';?>
<table cellpadding="1" cellspacing="1" id="alliance" class="row_table_data">
	<thead>
		<tr><td></td><td><?php echo ALLIANCE;?></td><td><?php echo PLAYERS;?></td><td>Ø</td><td><?php echo POINTS;?></td></tr>
		</thead><tbody>
<?php
