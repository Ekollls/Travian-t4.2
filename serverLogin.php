...
<a class="link" onclick="" href="login.php" title="<?php echo JR_LOGINTO.' '.JR_SERVER1_NAME; ?>.">
...
<!--div class="server serverA serverbig servernormal serverbignormal ">
<a class="link" onclick="" href="t36/login.php" title="<?php echo JR_LOGINTO.' '.JR_SERVER2_NAME; ?>.">
